...
# `npm run build` emits the production admin bundle into dist/build.
# Keep a compatibility copy at /app/build in case runtime dist detection changes.
RUN mkdir -p /app/build && \
    cp -R /app/dist/build/. /app/build/
